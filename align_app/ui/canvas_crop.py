"""Crop helpers mixed into CanvasCore."""
...
class CropMixin:
    """Provides crop-mode methods to be used by CanvasCore."""

    def start_crop_mode(self, use_aligned: Optional[bool]) -> None:
        """Enter crop mode; if use_aligned is None, ask the user."""
        # expects: self.base_full, self.crop_out, self.rubber, self.left_rect, etc.
